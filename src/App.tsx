...
import GameBaccarat from "./pages/GameBaccarat";
...
function ProtectedRoute({ children }: { children: React.ReactNode }) {
  ...
  if (loading) return <div className="min-h-screen gradient-vip flex items-center justify-center text-gold text-xl">⏳ Đang tải...</div>;
      ...
      <BrowserRouter>
        <AuthProvider>
          <Routes>
            ...
            <Route path="/game/baccarat" element={<ProtectedRoute><GameBaccarat /></ProtectedRoute>} />
