...
const PKG_META: Record<string, { emoji: string; badge?: string; badgeColor?: string; features: string[] }> = {
  "1day": {
    ...
    badge: "🧧 Lì Xì 1 Key",
    badgeColor: "#ff6a6a",
    features: ["24 giờ sử dụng", "1 thiết bị đồng thời", "Cập nhật liên tục", "Hỗ trợ 24/7"],
  },
  "3days": {
    emoji: "🔥",
    badge: "💰 TIẾT KIỆM 32%",
    badgeColor: "#ff8c00",
    features: ["3 ngày sử dụng", "1 thiết bị đồng thời", "Ưu tiên hỗ trợ", "Chỉ " + formatVND(70000 / 3) + "/ngày"],
  },
  "1week": {
    emoji: "⭐",
    badge: "🎉 TIẾT KIỆM 55%",
    badgeColor: "#00c3ff",
    features: ["7 ngày sử dụng", "1 thiết bị đồng thời", "Hỗ trợ ưu tiên"],
  },
  "1month": {
    emoji: "🏆",
    badge: "🏅 TIẾT KIỆM 76%",
    badgeColor: "#00ff88",
    features: ["30 ngày sử dụng", "1 thiết bị đồng thời", "Hỗ trợ 24/7"],
  },
  "lifetime": {
    emoji: "👑",
    badge: "💎 VIP TRỌN ĐỜI",
    badgeColor: "#ffd700",
    features: ["Sử dụng vĩnh viễn", "1 thiết bị đồng thời", "Hỗ trợ VIP ưu tiên", "Cập nhật miễn phí"],
  },
};
        ...
        {!selectedPkg ? (
          <div className="space-y-5">
            ...
            <div className="rounded-2xl p-5 text-center" style={{
              ...
              <h2 className="text-xl font-black tracking-wide" style={{ color: "#c0392b" }}>
                🏷️ BẢNG GIÁ KEY TẾT 2026
              </h2>
                ...
                return (
                  ...
                  >
                    <div className="rounded-2xl p-4 h-full flex flex-col" style={{
                      ...
                      <div className="mb-2">
                        <h3 className="font-black text-sm" style={{ color: "#1a0a00" }}>
                          {meta?.emoji} {p.label.toUpperCase()}
                        </h3>
                        <p className="text-2xl font-black mt-1" style={{ color: "#c0392b" }}>
                          {formatVND(p.price)}
                        </p>
                      </div>

                      {meta?.badge && (
                        <span className="inline-block self-start px-3 py-1 rounded-full text-[10px] font-bold text-white mb-3" style={{
            ...
            {/* Bottom CTA */}
            <button
              onClick={() => setSelectedPkg(KEY_PACKAGES[0].id)}
          ...
          <div className="space-y-4" style={{ animation: "fadeIn 0.4s ease-out" }}>
            <div className="rounded-2xl p-[2px]" style={{
              ...
              <div className="rounded-2xl p-5 space-y-4" style={{
                ...
                <h2 className="text-center font-black text-lg" style={{ color: "#c0392b" }}>
                  💳 Thanh Toán - Gói {pkg?.label}
                </h2>
                <p className="text-center text-3xl font-black" style={{ color: "#1a0a00" }}>
                  {pkg && formatVND(pkg.price)}
                </p>

                <img src="/qr-bidv.jpeg" alt="QR BIDV" className="mx-auto rounded-xl max-w-[220px]" style={{
                  border: "3px solid #ffae00",
                  boxShadow: "0 4px 20px rgba(255,174,0,0.3)",
                }} />
                ...
                <div className="p-3 rounded-xl space-y-2 text-sm" style={{
                  ...
                  <p style={{ color: "#666" }}>Ngân hàng: <span className="font-bold" style={{ color: "#1a0a00" }}>BIDV</span></p>
                  <p style={{ color: "#666" }}>Chủ TK: <span className="font-bold" style={{ color: "#1a0a00" }}>Nguyen Thanh Nhan</span></p>
                  <p style={{ color: "#666" }}>STK: <span className="font-bold" style={{ color: "#c0392b" }}>8887596710</span></p>
